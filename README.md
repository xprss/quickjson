...
La CI viene eseguita su pull request e push a `master`, con Wrapper validation, test, lint, APK debug e test strumentati su API 31 e 37. Tutte le Actions sono bloccate a SHA completo e gli artifact temporanei scadono dopo sette giorni.
